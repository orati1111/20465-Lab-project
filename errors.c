...
errorMapping error_map[] = {{ERROR_ILLEGAL_MACRO_NAME,            ERR_MSG_ILLEGAL_MACRO_NAME},
                            ...
                            {ERROR_UNKNOWN_LABEL,                 ERR_MSG_UNKNOWN_LABEL},
                            {ERROR_ENTRY_NOT_DECLARED,            ERR_MSG_ENTRY_NOT_DECLARED},
